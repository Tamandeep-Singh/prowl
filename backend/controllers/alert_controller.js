...
class AlertController {
    ...
    static sendAlert = async (alert, recipients) => {
        await this.sendDiscordAlert({embeds: [{
            ...
            color: 0x00b0f4,
            url: `${process.env.PROWL_FRONTEND_HUB}/dashboard/alerts`,
            ...
            await this.sendEmailAlert({
                ...
                body: `<div style="background-color:#3A3F4B; color:white; font-family:Arial; padding: 30px; border-radius: 8px; width: 700px; margin: auto;">
                        ...
                        <div style="text-align: center; margin-bottom: 20px; margin-top: 20px;">
                            <a href="${process.env.PROWL_FRONTEND_HUB}/dashboard/alerts" style="padding: 10px; display: inline-block; width: 200px; background-color: rgb(25, 118, 210); color: white; text-decoration:none; border-radius:6px; font-weight:bold;">Go to Alerts</a>
                        </div>
